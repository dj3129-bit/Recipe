	...
	<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/post/add">
		<div class="container">
			<div class="info">
				...
				<div>
					<h3>레시피 제목</h3>
					<input type="text" name="recipetitle" class="shortext">
				</div>
				<div>
					<h3>레시피 소개</h3>
					<input type="textarea" name="introduce" class="longtext">
				</div>
				<div>
					<h3>태그</h3>
					<input type="text" name="recipetag" class="shortext">
				</div>
				<div>
					<h3>공개여부</h3>
